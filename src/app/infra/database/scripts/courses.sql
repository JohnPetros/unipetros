...
VALUES 
('Data Science Aplicada para Negócios', 'Este curso se concentra em aplicar técnicas de Data Science para resolver problemas de negócios, utilizando ferramentas como Python, R e SQL. Os alunos aprendem a analisar grandes volumes de dados, criar modelos preditivos e visualizar insights de forma eficaz.'),
('Inteligência Artificial e Machine Learning', 'Este curso abrange os fundamentos da Inteligência Artificial e Machine Learning, ensinando como desenvolver algoritmos que podem aprender e melhorar com os dados. Os tópicos incluem redes neurais, aprendizado profundo e técnicas de otimização.'),
('Desenvolvimento Web Moderno', 'Focado em tecnologias front-end e back-end, este curso ensina os desenvolvedores a criar aplicações web responsivas e interativas. Os alunos aprendem a usar frameworks populares como React, Angular e Vue.js, além de linguagens de back-end como Node.js e Python.'),
('Gestão de Projetos Ágeis', 'Este curso ensina as práticas e metodologias de gestão de projetos ágeis, como Scrum e Kanban, para melhorar a eficiência e a qualidade do desenvolvimento de software. Os alunos aprendem a planejar, executar e controlar projetos de forma iterativa e incremental.'),
